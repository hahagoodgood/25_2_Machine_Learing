...
- ✅ **포괄적인 평가**: Confusion matrix, ROC curves, 클래스별 metrics
...
- 최고 검증 정확도 모델을 `checkpoints/` 디렉토리에 저장
...
3. **학습률 튜닝**: 기본값 0.001이 잘 작동하지 않으면 조정
4. **Early stopping 활용**: patience 값으로 조기 종료 시점 제어
